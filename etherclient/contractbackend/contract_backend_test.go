...
import (
	...
	mock_contract_backend "github.com/forta-network/core-go/etherclient/contractbackend/mocks"
...
func TestFastBackend(t *testing.T) {
	...
	mockBackend := mock_contract_backend.NewMockContractBackend(gomock.NewController(t))
