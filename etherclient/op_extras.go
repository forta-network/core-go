...
func (ec *opEtherClient) DebugTraceCall(
	...
	return withBackoff(ctx, ec.provider, "DebugTraceCall()", func(ctx context.Context, ethClient OpEthClient) error {
...
func (ec *opEtherClient) GetBlockRawTransactions(ctx context.Context, number *big.Int) ([]string, error) {
